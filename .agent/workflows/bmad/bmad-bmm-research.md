...
```
/research --scope auth        # Flag format
/research --scope=auth        # Flag with equals
/research auth                # Positional (last arg if matches scope pattern)
```
...
NOW: LOAD the FULL @_bmad/bmm/workflows/1-analysis/research/workflow.md, READ its entire contents and follow its directions exactly!
