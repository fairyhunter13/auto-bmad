...
```
/testarch-test-review --scope auth        # Flag format
/testarch-test-review --scope=auth        # Flag with equals
/testarch-test-review auth                # Positional (last arg if matches scope pattern)
```
