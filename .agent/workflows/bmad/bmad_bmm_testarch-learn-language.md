---
description: 'Learn testing patterns for unknown or new languages through collaborative user interaction'
---
...
1. Inline flag: `/testarch-learn-language --scope auth` or `/testarch-learn-language auth`
...
2. READ its entire contents - this is the CORE OS for EXECUTING the specific workflow-config @_bmad/bmm/workflows/testarch/learn-language/workflow.yaml
3. Pass the yaml path _bmad/bmm/workflows/testarch/learn-language/workflow.yaml as 'workflow-config' parameter to the workflow.xml instructions
