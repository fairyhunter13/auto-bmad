...
```
/module --scope auth        # Flag format
/module --scope=auth        # Flag with equals
/module auth                # Positional (last arg if matches scope pattern)
```
...
NOW: LOAD the FULL @_bmad/bmb/workflows/module/workflow.md, READ its entire contents and follow its directions exactly!
