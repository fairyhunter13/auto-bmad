...
```
/testarch-framework --scope auth        # Flag format
/testarch-framework --scope=auth        # Flag with equals
/testarch-framework auth                # Positional (last arg if matches scope pattern)
```
