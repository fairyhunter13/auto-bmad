...
```
/create-excalidraw-flowchart --scope auth        # Flag format
/create-excalidraw-flowchart --scope=auth        # Flag with equals
/create-excalidraw-flowchart auth                # Positional (last arg if matches scope pattern)
```
