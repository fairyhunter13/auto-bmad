...
```
/creative-problem-solver --scope auth        # Flag format
/creative-problem-solver --scope=auth        # Flag with equals
/creative-problem-solver auth                # Positional (last arg if matches scope pattern)
```
...
- Echo: "**[SCOPE: {scope}]** Activating creative-problem-solver agent..."
