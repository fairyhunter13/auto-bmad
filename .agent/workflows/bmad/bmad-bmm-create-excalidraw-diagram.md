...
```
/create-excalidraw-diagram --scope auth        # Flag format
/create-excalidraw-diagram --scope=auth        # Flag with equals
/create-excalidraw-diagram auth                # Positional (last arg if matches scope pattern)
```
