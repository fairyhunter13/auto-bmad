...
```
/analyst --scope auth        # Flag format
/analyst --scope=auth        # Flag with equals
/analyst auth                # Positional (last arg if matches scope pattern)
```
...
- Echo: "**[SCOPE: {scope}]** Activating analyst agent..."
