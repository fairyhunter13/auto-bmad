...
```
/ux-designer --scope auth        # Flag format
/ux-designer --scope=auth        # Flag with equals
/ux-designer auth                # Positional (last arg if matches scope pattern)
```
...
- Echo: "**[SCOPE: {scope}]** Activating ux-designer agent..."
