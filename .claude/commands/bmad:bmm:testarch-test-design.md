...
```
/testarch-test-design --scope auth        # Flag format
/testarch-test-design --scope=auth        # Flag with equals
/testarch-test-design auth                # Positional (last arg if matches scope pattern)
```
