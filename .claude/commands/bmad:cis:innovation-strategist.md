...
```
/innovation-strategist --scope auth        # Flag format
/innovation-strategist --scope=auth        # Flag with equals
/innovation-strategist auth                # Positional (last arg if matches scope pattern)
```
...
- Echo: "**[SCOPE: {scope}]** Activating innovation-strategist agent..."
