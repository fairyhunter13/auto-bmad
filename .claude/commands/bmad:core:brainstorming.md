...
```
/brainstorming --scope auth        # Flag format
/brainstorming --scope=auth        # Flag with equals
/brainstorming auth                # Positional (last arg if matches scope pattern)
```
...
NOW: LOAD the FULL @_bmad/core/workflows/brainstorming/workflow.md, READ its entire contents and follow its directions exactly!
