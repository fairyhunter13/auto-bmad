...
```
/create-excalidraw-wireframe --scope auth        # Flag format
/create-excalidraw-wireframe --scope=auth        # Flag with equals
/create-excalidraw-wireframe auth                # Positional (last arg if matches scope pattern)
```
