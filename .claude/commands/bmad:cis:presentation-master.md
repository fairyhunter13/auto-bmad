...
```
/presentation-master --scope auth        # Flag format
/presentation-master --scope=auth        # Flag with equals
/presentation-master auth                # Positional (last arg if matches scope pattern)
```
...
- Echo: "**[SCOPE: {scope}]** Activating presentation-master agent..."
