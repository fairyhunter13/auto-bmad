...
```
/generate-project-context --scope auth        # Flag format
/generate-project-context --scope=auth        # Flag with equals
/generate-project-context auth                # Positional (last arg if matches scope pattern)
```
...
NOW: LOAD the FULL @_bmad/bmm/workflows/generate-project-context/workflow.md, READ its entire contents and follow its directions exactly!
