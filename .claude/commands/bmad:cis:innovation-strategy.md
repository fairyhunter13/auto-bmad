...
```
/innovation-strategy --scope auth        # Flag format
/innovation-strategy --scope=auth        # Flag with equals
/innovation-strategy auth                # Positional (last arg if matches scope pattern)
```
