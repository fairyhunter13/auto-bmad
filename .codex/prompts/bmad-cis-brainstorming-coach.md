...
```
/brainstorming-coach --scope auth        # Flag format
/brainstorming-coach --scope=auth        # Flag with equals
/brainstorming-coach auth                # Positional (last arg if matches scope pattern)
```
...
- Echo: "**[SCOPE: {scope}]** Activating brainstorming-coach agent..."
