...
1. Inline flag: `/testarch-language-inference --scope auth` or `/testarch-language-inference auth`
...
2. READ its entire contents - this is the CORE OS for EXECUTING the specific workflow-config @_bmad/bmm/workflows/testarch/language-inference/workflow.yaml
3. Pass the yaml path _bmad/bmm/workflows/testarch/language-inference/workflow.yaml as 'workflow-config' parameter to the workflow.xml instructions
