...
```
/create-epics-and-stories --scope auth        # Flag format
/create-epics-and-stories --scope=auth        # Flag with equals
/create-epics-and-stories auth                # Positional (last arg if matches scope pattern)
```
...
NOW: LOAD the FULL @_bmad/bmm/workflows/3-solutioning/create-epics-and-stories/workflow.md, READ its entire contents and follow its directions exactly!
