...
```
/agent-builder --scope auth        # Flag format
/agent-builder --scope=auth        # Flag with equals
/agent-builder auth                # Positional (last arg if matches scope pattern)
```
...
- Echo: "**[SCOPE: {scope}]** Activating agent-builder agent..."
