...
```
/bmad-master --scope auth        # Flag format
/bmad-master --scope=auth        # Flag with equals
/bmad-master auth                # Positional (last arg if matches scope pattern)
```
...
- Echo: "**[SCOPE: {scope}]** Activating bmad-master agent..."
