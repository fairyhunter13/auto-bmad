...
```
/create-architecture --scope auth        # Flag format
/create-architecture --scope=auth        # Flag with equals
/create-architecture auth                # Positional (last arg if matches scope pattern)
```
