...
```
/create-excalidraw-dataflow --scope auth        # Flag format
/create-excalidraw-dataflow --scope=auth        # Flag with equals
/create-excalidraw-dataflow auth                # Positional (last arg if matches scope pattern)
```
