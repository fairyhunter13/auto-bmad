...
```
/workflow-builder --scope auth        # Flag format
/workflow-builder --scope=auth        # Flag with equals
/workflow-builder auth                # Positional (last arg if matches scope pattern)
```
...
- Echo: "**[SCOPE: {scope}]** Activating workflow-builder agent..."
