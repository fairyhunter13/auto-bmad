...
```
/module-builder --scope auth        # Flag format
/module-builder --scope=auth        # Flag with equals
/module-builder auth                # Positional (last arg if matches scope pattern)
```
...
- Echo: "**[SCOPE: {scope}]** Activating module-builder agent..."
