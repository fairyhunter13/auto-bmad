...
```
/design-thinking-coach --scope auth        # Flag format
/design-thinking-coach --scope=auth        # Flag with equals
/design-thinking-coach auth                # Positional (last arg if matches scope pattern)
```
...
- Echo: "**[SCOPE: {scope}]** Activating design-thinking-coach agent..."
