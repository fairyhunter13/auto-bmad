...
```
/storyteller --scope auth        # Flag format
/storyteller --scope=auth        # Flag with equals
/storyteller auth                # Positional (last arg if matches scope pattern)
```
...
- Echo: "**[SCOPE: {scope}]** Activating storyteller agent..."
