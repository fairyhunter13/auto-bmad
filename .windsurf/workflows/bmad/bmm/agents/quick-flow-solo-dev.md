...
```
/quick-flow-solo-dev --scope auth        # Flag format
/quick-flow-solo-dev --scope=auth        # Flag with equals
/quick-flow-solo-dev auth                # Positional (last arg if matches scope pattern)
```
...
- Echo: "**[SCOPE: {scope}]** Activating quick-flow-solo-dev agent..."
