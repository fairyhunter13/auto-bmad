...
```
/tech-writer --scope auth        # Flag format
/tech-writer --scope=auth        # Flag with equals
/tech-writer auth                # Positional (last arg if matches scope pattern)
```
...
- Echo: "**[SCOPE: {scope}]** Activating tech-writer agent..."
